...
class DeptTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        deptArray.append( deptInfo(organizer: "Department of Computer Science" ) )
        
        deptArray.append( deptInfo(organizer: "Department of Arts" ) )
        
        deptArray.append( deptInfo(organizer: "Department of Communication") )
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "showDept" {
            ...
            if let viewController = segue.destination as? EventTableViewController {
                ...
                viewController.organizer = deptArray[selectedIndex.row].organizer
