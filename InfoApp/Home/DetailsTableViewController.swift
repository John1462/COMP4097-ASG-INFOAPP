...
class DetailsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.title = self.Details_name
        
        print(self.Details_name)
        ...
        print("Result: \(response.result)") // response serialization result
            ...
            switch response.result {
                ...
                case .success(let value):
                    ...
                    self.realmResults = realm.objects(HomeEvent.self).filter("name == '\(self.Details_name)'")
                    
                    print("Details_name: \(self.Details_name)")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let results1 = realmResults{
                cell.textLabel?.text = results1[indexPath.row].name
        }
           return cell
    }
